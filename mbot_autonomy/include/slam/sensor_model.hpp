...
private:
    ...
    double scoreRay(const mbot_lcm_msgs::particle_t& sample, const adjusted_ray_t& ray, const OccupancyGrid& map);
    Point<float> getRayEndPointOnMap(const mbot_lcm_msgs::particle_t& sample, const adjusted_ray_t& ray, const OccupancyGrid& map);
